function I = ConfigFile1(outname,pos,filename,sampfreq)
%% file name
...
I.Stationarity.StationaryMethod = 'Polynomial fit'; % Method to be used for making the signal stationary: 'Polynomial fit' or 'Inbuilt Detrend'. 
                                                    % 'NA' if not applicable
                                                    
%% Spurious samples
I.Spurios.DetectionMethod = 'Histogram';    % Histogram or Chauvenet
I.Spurious.Chauvenet.n = 'Default';         % Default or numerical value of std deviation for Chauvenet method, 
                                            % 'NA' if not applicable
I.Spurious.Histogram.Bins = 20;             % No. of bins in case of Histogram method, 'NA' if not applicable
I.Spurious.Postprocessing = 'Replacement';  % Removal or Replacement or 'NA' for leaving he signal as it is
...
%% Periodicity
I.Periodicity.Window = 'hamming';           % hamming, hann, rectwin, chebwin, gausswin, triang, or NA for not performing the anlysis
...
I.Periodicity.DiscreteFFT = 6554;           % No. of discrete FFT points,
I.Periodicity.RemovePeriodic = 'Yes';       % 'Yes' for removing periodic component and 'No' for leaving the signal as it is
...
I.Spectral.DiscreteFFT = 6554;              % No. of discrete FFT points
I.Spectral.TimeShift = 130;                 % Total lag number (=time lag / Delta t) for integrating rho for the integral time scale,
