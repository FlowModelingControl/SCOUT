...
U.Uncertainty.InputSystematic = 'Yes';     % Systemtaic uncertainty: 'Yes' if needed, 'No' when not needed
U.Uncertainty.TimeShift = 130;            % Total lag number (=time lag / Delta t) for integrating rho for the integral time scale,
...
U.Uncertainty.Systematic1 = 0.01;         % Relative systematic uncertainty,'NA' if not applicable
